                ...
                <div class="information">
                    <div class="content-left">
                        ...
                        <div class="descripton">
                            <p style="width: 350px;">Travel is the movement of people between relatively distant geographical locations, and
                                can involve travel by foot, bicycle,...</p>
                        </div>
                    </div>
                    <div class="content-right">
                        <div class="discount-badge">8% Off</div>
                        <div class="price" style="margin-bottom: 5px;"><strong style="font-size: 20px;">$1,100</strong> <del style="font-size: small;">$1,200</del></div>
