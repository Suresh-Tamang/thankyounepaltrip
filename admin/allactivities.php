                            ...
                            <table class="min-w-full" id="userTable">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    <tr>
                                        ...
                                        <td class="px-6 py-4"><span class="px-2 py-1 text-sm bg-green-100 text-green-800 rounded-full">Active</span></td>
                                        <td class="px-6 py-4">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4"><span class="px-2 py-1 text-sm bg-red-100 text-green-800 rounded-full">Expire</span></td>
                                        <td class="px-6 py-4">
                                            <button class="text-blue-500 hover:text-blue-700">Edit</button>
                                            <button class="text-red-500 hover:text-red-700 ml-2 delete-btn">Delete</button>
                                        </td>
